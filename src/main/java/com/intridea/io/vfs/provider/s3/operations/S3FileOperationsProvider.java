...
// S3FileOperationsProvider.java --
//
// S3FileOperationsProvider.java is part of ElectricCommander.
//
    ...
    implements FileOperationProvider
{
    ...
    /**
     * Depending on operationClass return getter/setter for file access control
     * list.
     *
     * @param   file
     * @param   operationClass
     *
     * @return  depending on operationClass return getter/setter for file access
     *          control list.
     *
     * @throws  FileSystemException
     */
        ...
        throws FileSystemException
    {
        ...
        throw new FileSystemException(
            "vfs.provider.s3/unsupported_operation.error",
